...
print "Scrapper to download most time efficient solution to a contest problem by given user."
print "***It will not work during the contest on other users.***"
print "The info U enter below will be case-sensitive"
global username
username=raw_input("Username:")					

global contestname
contestname=raw_input("Contest:")

global problem
problem=raw_input("Problem:")

link='/'+contestname+'/status/'+problem+','+username

try:
	print "Getting id of solution..."
	sol_link,lang,time=get_sol_id(link)
except :
	print "Unable to find AC solution of given user to the given problem in given contest"
else :
